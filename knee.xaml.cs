...
namespace DetectVGBGesture
{
    ...
    /// </summary>
    public sealed partial class knee : Page
    {
        ...
        string trainNameCur = "무릎";
        string trainTypeCur = "전방십자인대파열";
        string writerCur;
        string yn = "Y";
...
//            Unloaded += MainPage_Unloaded;
        ...
        void MainPage_Loaded(object sender, RoutedEventArgs evt)
        {
            ...
            _gestureDatabase = new VisualGestureBuilderDatabase(@"Gestures/knee.gbd");

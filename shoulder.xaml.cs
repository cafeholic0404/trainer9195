...
namespace DetectVGBGesture
{
    ...
    public sealed partial class shoulder : Page
    {
        ...
        string trainNameCur = "어깨";
        string trainTypeCur = "회전근개파열";
        string writerCur;
        string yn="Y";
 ...
 //         Unloaded += MainPage_Unloaded;
        ...
        void MainPage_Loaded(object sender, RoutedEventArgs evt)
        {
            ...
            _gestureDatabase = new VisualGestureBuilderDatabase(@"Gestures/shoulder.gbd");
